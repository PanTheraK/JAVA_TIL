...
@FunctionalInterface // 여기 아래에 나오는 인터페이스는 람다표현식으로 만들 때 사용할 인터페이스 --> 컴파일러에게 통지
...
public class LambdaExam01 {
    public static void main(String[] args) {
        ...
        // 인터페이스 종류 : Supplier,Consumer , Fuction,pradicate
        ...
        // 클래스 이름::메소드이름 or 참조변수 이름::메소드이름
        // String s; --> s가 참조변수 이름
        Function<String, Integer> function2 = String::length;
        System.out.println(function2.apply("좋은 아침 ~~"));
        // 생성자 참조(constructor reference) ● 잘 안씀
